...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_v4bc91h', 'template_cos59tf', form.current, 'p-QHZ7m2eBhraTUOn')
      .then(
        () => {
    ...
    <>
      <div className="container contact-page">
        <div className="text-zone">
          ...
          <p>
            I am interested in taking up new challenges & opportunities - especially on ambitious
